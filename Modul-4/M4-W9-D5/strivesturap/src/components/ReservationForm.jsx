...
updateReservationField = event => {
    ...
    // reservation[currentId] : same as:  reservation.name=evemt.currentTarget.value
    // reservation[currentId] - i kolekton te gjithe te dhanat dhe i ndryshon njekohesisht
